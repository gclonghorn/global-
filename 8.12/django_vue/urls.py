...
#添加权限修改
router.register(r'DocRoleEditViewset', DocRoleEditViewset, basename='DocRoleEdit')
#添加文档状态修改
router.register(r'DocStatusEditViewset', DocStatusEditViewset, basename='DocStatusEdit')
#最近浏览文档
router.register(r'RecentDocViewset', RecentDocViewset, basename='RecentDocViewset')
#查看协作者
router.register(r'CoworkerViewset', CoworkerViewset, basename='CoworkerViewset')
#查看他人个人信息
router.register(r'OtherInfoViewset', OtherInfoViewset, basename='OtherInfoViewset')
#展示我的团队
router.register(r'MyTeamViewset', MyTeamViewset, basename='MyTeamViewset')
#展示我的文档
router.register(r'MyDocViewset', MyDocViewset, basename='MyDocViewset')
