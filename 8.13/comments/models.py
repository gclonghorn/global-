...
# Create your models here.class Comment (models.Model):
    dec=models.ForeignKey(Document, on_delete=models.CASCADE, default=1, related_name='comments', verbose_name="文档", help_text="被评论文档")
...
class UserCol(models.Model):
    ...
    用户收藏
    """
    create_user = models.ForeignKey(User, on_delete=models.CASCADE, default=1, related_name='collect', verbose_name="收藏者")
    dec = models.ForeignKey(Document, on_delete=models.CASCADE, default=1, related_name='collects', verbose_name="文档",help_text="被收藏文档")
    create_time = models.DateTimeField(default=timezone.now, verbose_name="收藏时间", help_text="用户收藏时间")


    class Meta:
        ordering = ['-create_time']
        unique_together = ("create_user", "dec")  # 一个用户对一个文档只能收藏一次
